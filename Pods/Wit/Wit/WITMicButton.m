...
static const CGFloat kMicHeight = 35.0f;
static const CGFloat kMicWidth = 23.0f;
...
- (void)defaultStyles {
    ...
    UIColor* strokeColor = [UIColor colorWithRed:0.5f green:0.5f blue:0.5f alpha:0.3f];
    
    // outer circle
    self.outerCircleView = [[WITCircleView alloc] init];
    self.outerCircleView.opaque = NO;
    self.outerCircleView.backgroundColor = strokeColor;
    self.outerCircleView.strokeColor = strokeColor;
    self.outerCircleView.fillColor = [UIColor colorWithRed:0.94f green:0.94f blue:0.94f alpha:0.3f];
    ...
    self.innerCircleView.fillColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:0.4];;
...
- (void)twoPulses {
    ...
    UIColor* pulseColor = [UIColor colorWithRed:0.92f green:0.91f blue:0.92f alpha:0.5f];
